...
/*   Updated: 2021/10/14 10:59:32 by user42           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "ft_nm.h"

void	header_part_1_x64(Elf64_Ehdr *header)
{
...
void	header_part_2_x64(Elf64_Ehdr *header)
{
	printf("> OS/ABI:				");
...
void	header_part_3_x64(Elf64_Ehdr *header)
{
	printf("> Type:					");
...
{
	printf("	==== ELF FILE HEADER ====\n");
	header_part_1_x64(header);
	header_part_2_x64(header);
	header_part_3_x64(header);
