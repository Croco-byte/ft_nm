...
/*   Updated: 2021/10/14 10:53:00 by user42           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "ft_nm.h"

void	section_part_1_x64(Elf64_Shdr *sec_headers,
...
void	section_part_2_x64(Elf64_Shdr *sec_headers, int i)
{
...
void	section_part_3_x64(Elf64_Shdr *sec_headers, int i)
{
...
void	section_part_4_x64(Elf64_Shdr *sec_headers, int i)
{
	...
	printf(" | ");
	printf("%10lx", sec_headers[i].sh_offset);
	printf(" | ");
			...
			const char *sec_strtab_pointer)
{
	...
	{
		section_part_1_x64(sec_headers, sec_strtab_pointer, i);
		section_part_2_x64(sec_headers, i);
		section_part_3_x64(sec_headers, i);
		section_part_4_x64(sec_headers, i);
		printf("\n");
	}
}
